...
def classify0(inX, dataSet, labels, K):
    ...
    # 1. 距离计算
    #计算数据大小
    #todo 二维数组y.shape[0]代表行数，y.shape[1]代表列数
    #todo 三维数组x.shape[0]代表包含二维数组的个数，x.shape[1]表示二维数组的行数，x.shape[2]表示二维数组的列数。
    #todo shape[0]表示最外围的数组的维数，shape[1]表示次外围的数组的维数，数字不断增大，维数由外到内。
