...
'''
def plotDataSet():
    xArr, yArr = loadDataSet('D:/python/AILearners/data/ml/jqxxsz/8.Regression/ex0.txt')                                    #加载数据集
    n = len(xArr)                                                        #数据个数
    xcord = []; ycord = []                                                #样本点
    for i in range(n):                                                   
...
if __name__ == "__main__":
    ...
    # plotRegression()
    #
    # xArr, yArr = loadDataSet('D:/python/AILearners/data/ml/jqxxsz/8.Regression/ex0.txt')
    # ws = standRegres(xArr, yArr)                                        #计算回归系数
    # xMat = np.mat(xArr)                                                    #创建xMat矩阵
    # yMat = np.mat(yArr)                                                    #创建yMat矩阵
    # yHat = xMat * ws
