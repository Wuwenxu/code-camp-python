...
def loadDataSet():
    ...
    labelMat = []
    #打开文件 
    fr = open('D:/python/AILearners/data/ml/jqxxsz/5.Logistic/testSet.txt')
    #逐行读取
...
def gradAscent(dataMatIn, classLabels):
    ...
    #调换矩阵的坐标顺序，对于二维矩阵来说，transpose()就是转置,相当图片的旋转
...
def plotBestFit(weights):
    ...
    #todo 通过回归系数带入公式，求Y 一个y 60size的小数，和x60size的小数组合，生成一条线
    ax.plot(x, y)
    #title
    plt.title('BestFit')    
    #label                                            
